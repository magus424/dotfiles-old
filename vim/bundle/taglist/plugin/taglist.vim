...
let s:tlist_def_fortran_settings = 'fortran;p:program;b:block data;' .
                    ...
                    \ 'n:namelist;t:derived;f:function;v:variable;s:subroutine'
...
let s:tlist_def_sql_settings = 'sql;c:cursor;F:field;P:package;r:record;' .
            \ 's:subtype;t:table;T:trigger;f:function;v:variable;p:procedure'
...
let s:tlist_def_verilog_settings = 'verilog;m:module;c:constant;P:parameter;' .
            \ 'e:event;r:register;t:task;w:write;p:port;f:function;v:variable'

" vim language
let s:tlist_def_vim_settings = 'vim;a:autocmds;f:function;v:variable'
...
function! s:Tlist_Window_Init()
    ...
    nnoremap <buffer> <silent> <ScrollWheelUp> <Nop>
